...
public enum EMVStandardTagType implements EMVTagType {
    ...
    /** EMV tag: Account Type. Indicates the type of account selected on the terminal, coded as specified in Annex G. */
    ...
    /** EMV tag: Acquirer Identifier. Uniquely identifies the acquirer within each payment system. */
    ...
    /** EMV tag: Additional Terminal Capabilities. Indicates the data input and output capabilities of the terminal. */
    ...
    /** EMV tag: Amount, Authorised (Binary). Authorised amount of the transaction (excluding adjustments). */
    ...
    /** EMV tag: Amount, Authorised (Numeric). Authorised amount of the transaction (excluding adjustments). */
    ...
    /** EMV tag: Amount, Other (Binary). Secondary amount associated with the transaction representing a cashback amount. */
    ...
    /** EMV tag: Amount, Other (Numeric). Secondary amount associated with the transaction representing a cashback amount. */
    ...
    /** EMV tag: Amount, Reference Currency. Authorised amount expressed in the reference currency. */
    AMOUNT_REFERENCE_CURRENCY_0x9F3A(0x9F3A, "Amount, Reference Currency",
            ...
            TLVDataFormat.BINARY, new FixedDataLength(4), 0x00, new FixedByteLength(4)),
    /** EMV tag: Application Cryptogram. Cryptogram returned by the ICC in response of the GENERATE AC command. */
    ...
    /** EMV tag: Application Currency Code. Indicates the currency in which the account is managed according to ISO 4217. */
    ...
    /** EMV tag: Application Currency Exponent. Indicates the implied position of the decimal point from the right of the amount represented according to ISO 4217. */
    APPLICATION_CURRENCY_EXPONENT_0x9F44(
            ...
            new FixedByteLength(1)),
    /** EMV tag: Application Dedicated File (ADF) Name. Identifies the application as described in ISO/IEC 7816-5. */
    ...
    /** EMV tag: Application Discretionary Data. Issuer or payment system specified data relating to the application. */
    ...
    /** EMV tag: Application Effective Date. Date from which the application may be used. */
    ...
    /** EMV tag: Application Expiration Date. Date after which application expires. */
    APPLICATION_EXPIRATION_DATE_0x5F24(0x5F24, "Application Expiration Date",
            ...
            new FixedDataLength(6), 0x70, new FixedByteLength(3)),
    /** EMV tag: Application File Locator (AFL). Indicates the location (SFI, range of records) of the AEFs related to a given application. */
    ...
    /** EMV tag: Application Identifier (AID) – terminal. Identifies the application as described in ISO/IEC 7816-5. */
    ...
    /** EMV tag: Application Interchange Profile. Indicates the capabilities of the card to support specific functions in the application. */
    ...
    /** EMV tag: Application Label. Mnemonic associated with the AID according to ISO/IEC 7816-5. */
    ...
    /** EMV tag: Application Preferred Name. Preferred mnemonic associated with the AID. */
    APPLICATION_PREFERRED_NAME_0x9F12(0x9F12, "Application Preferred Name",
            ...
            new VariableByteLength(1, 16)),
    /** EMV tag: Application Primary Account Number (PAN). Valid cardholder account number. */
    ...
    /** EMV tag: Application Primary Account Number (PAN) Sequence Number. Identifies and differentiates cards with the same PAN. */
    ...
    /** EMV tag: Application Priority Indicator. Indicates the priority of a given application or group of applications in a directory. */
    ...
    /** EMV tag: Application Template. Contains one or more data objects relevant to an application directory entry according to ISO/IEC 7816-5. */
    ...
    /** EMV tag: Application Transaction Counter (ATC). Counter maintained by the application in the ICC (incrementing the ATC is managed by the ICC). */
    APPLICATION_TRANSACTION_COUNTER_0x9F36(
            ...
            DataSource.ICC, TLVDataFormat.BINARY, new FixedDataLength(2), 0x77, new FixedByteLength(2)),
    /** EMV tag: Application Usage Control. Indicates issuer’s specified restrictions on the geographic usage and services allowed for the application. */
    ...
    /** EMV tag: Application Version Number (ICC). Version number assigned by the payment system for the application. From ICC. */
    APPLICATION_VERSION_NUMBER_ICC_0x9F08(0x9F08, "Application Version Number (ICC)",
            ...
            DataSource.ICC, TLVDataFormat.BINARY, new FixedDataLength(2), 0x70, new FixedByteLength(2)),
    /** EMV tag: Application Version Number (Terminal). Version number assigned by the payment system for the application. From Terminal. */
    ...
    /** EMV tag: Authorisation Code. Value generated by the authorisation authority for an approved transaction. */
    ...
    /** EMV tag: Authorisation Response Code. Code that defines the disposition of a message. */
    ...
    /** EMV tag: Card Risk Management Data Object List 1 (CDOL1). List of data objects (tag and length) to be passed to the ICC in the first GENERATE AC command. */
    CARD_RISK_MANAGEMENT_DATA_OBJECT_LIST_1_0x8C(
            ...
            new VariableByteLength(1, 252)),
    /** EMV tag: Card Risk Management Data Object List 2 (CDOL2). List of data objects (tag and length) to be passed to the ICC in the second GENERATE AC command. */
    CARD_RISK_MANAGEMENT_DATA_OBJECT_LIST_2_0x8D(
            ...
            DataSource.ICC, TLVDataFormat.BINARY, new VariableDataLength(1, 252), 0x70,
            new VariableByteLength(1, 252)),
    /** EMV tag: Cardholder Name. Indicates cardholder name according to ISO 7813. */
    ...
    /** EMV tag: Cardholder Verification Method (CVM) List. Identifies a method of verification of the cardholder supported by the application. */
    ...
    /** EMV tag: Cardholder Verification Method (CVM) Results. Indicates the results of the last CVM performed. */
    ...
    /** EMV tag: Certification Authority Public Key Index. Identifies the certification authority’s public key in conjunction with the RID. */
    ...
    CERTIFICATION_AUTHORITY_PUBLIC_KEY_INDEX_0x9F22(0x9F22,
            ...
            new FixedByteLength(1)),
    /** EMV tag: Command Template. Identifies the data field of a command message. */
    ...
    /** EMV tag: Cryptogram Information Data. Indicates the type of cryptogram and the actions to be performed by the terminal. */
    ...
    /** EMV tag: Dedicated File (DF) Name. Identifies the name of the DF as described in ISO/IEC 7816-4. */
    ...
    /** EMV tag: Directory Definition File (DDF) Name. Identifies the name of a DF associated with a directory. */
    DIRECTORY_DEFINITION_FILE_NAME_0x9D(0x9D, "Directory Definition File (DDF) Name",
            ...
            TLVDataFormat.BINARY, new VariableDataLength(5, 16), 0x61, new VariableByteLength(5, 16)),
    /** EMV tag: Directory Discretionary Template. Issuer discretionary part of the directory according to ISO/IEC 7816-5. */
    ...
    /** EMV tag: Dynamic Data Authentication Data Object List (DDOL). List of data objects (tag and length) to be passed to the ICC in the INTERNAL AUTHENTICATE command. */
    DYNAMIC_DATA_AUTHENTICATION_DATA_OBJECT_LIST_0x9F49(
            ...
            DataSource.ICC, TLVDataFormat.BINARY, new VariableDataLength(1, 252), 0x70,
            new VariableByteLength(1, 252)),
    /** EMV tag: File Control Information (FCI) Issuer Discretionary Data. Issuer discretionary part of the FCI. */
    ...
    /** EMV tag: File Control Information (FCI) Proprietary Template. Identifies the data object proprietary to this specification in the FCI template according to ISO/IEC 7816-4. */
    ...
    /** EMV tag: File Control Information (FCI) Template. Identifies the FCI template according to ISO/IEC 7816-4. */
    ...
    /** EMV tag: ICC Dynamic Number. Time-variant number generated by the ICC, to be captured by the terminal. */
    ...
    /** EMV tag: Integrated Circuit Card (ICC) PIN Encipherment Public Key Certificate. ICC PIN Encipherment Public Key certified by the issuer. */
    INTEGRATED_CIRCUIT_CARD_PIN_ENCIPHERMENT_PUBLIC_KEY_CERTIFICATE_0x9F2D(0x9F2D,
            ...
            ByteLength.BYTE_LENGTH_VAR)),
    /** EMV tag: Integrated Circuit Card (ICC) PIN Encipherment Public Key Exponent. ICC PIN Encipherment Public Key Exponent used for PIN encipherment. */
    ...
    /** EMV tag: Integrated Circuit Card (ICC) PIN Encipherment Public Key Remainder. Remaining digits of the ICC PIN Encipherment Public Key Modulus. */
    INTEGRATED_CIRCUIT_CARD_PIN_ENCIPHERMENT_PUBLIC_KEY_REMAINDER_0x9F2F(0x9F2F,
            ...
            DataLength.DATA_LENGTH_VAR), 0x70, new VariableByteLength(ByteLength.BYTE_LENGTH_VAR,
            ByteLength.BYTE_LENGTH_VAR)),
    /** EMV tag: Integrated Circuit Card (ICC) Public Key Certificate. ICC Public Key certified by the issuer. */
    INTEGRATED_CIRCUIT_CARD_PUBLIC_KEY_CERTIFICATE_0x9F46(0x9F46,
            ...
            new VariableByteLength(ByteLength.BYTE_LENGTH_VAR, ByteLength.BYTE_LENGTH_VAR)),
    /** EMV tag: Integrated Circuit Card (ICC) Public Key Exponent. ICC Public Key Exponent used for the verification of the Signed Dynamic Application Data. */
    ...
    /** EMV tag: Integrated Circuit Card (ICC) Public Key Remainder. Remaining digits of the ICC Public Key Modulus. */
    INTEGRATED_CIRCUIT_CARD_PUBLIC_KEY_REMAINDER_0x9F48(0x9F48,
            ...
            new VariableDataLength(DataLength.DATA_LENGTH_VAR, DataLength.DATA_LENGTH_VAR), 0x70,
            new VariableByteLength(ByteLength.BYTE_LENGTH_VAR, ByteLength.BYTE_LENGTH_VAR)),
    /** EMV tag: Interface Device (IFD) Serial Number. Unique and permanent serial number assigned to the IFD by the manufacturer. */
    ...
    /** EMV tag: Issuer Action Code - Denial. Specifies the issuer’s conditions that cause the denial of a transaction without attempt to go online. */
    ISSUER_ACTION_CODE_DENIAL_0x9F0E(
            ...
            DataSource.ICC, TLVDataFormat.BINARY, new FixedDataLength(5), 0x70, new FixedByteLength(5)),
    /** EMV tag: Issuer Action Code - Online. Specifies the issuer’s conditions that cause a transaction to be transmitted online. */
    ...
    /** EMV tag: Issuer Authentication Data. Data sent to the ICC for online issuer authentication. */
    ...
    /** EMV tag: Issuer Code Table Index. Indicates the code table according to ISO/IEC 8859 for displaying the Application Preferred Name. */
    ISSUER_CODE_TABLE_INDEX_0x9F11(
            ...
            new FixedByteLength(1)),
    /** EMV tag: Issuer Country Code. Indicates the country of the issuer according to ISO 3166. */
    ...
    /** EMV tag: Issuer Country Code (alpha2 format). Indicates the country of the issuer as defined in ISO 3166 (using a 2 character alphabetic code). */
    ...
    /** EMV tag: Issuer Country Code (alpha3 format). Indicates the country of the issuer as defined in ISO 3166 (using a 3 character alphabetic code). */
    ...
    /** EMV tag: Issuer Public Key Certificate. Issuer public key certified by a certification authority. */
    ...
    /** EMV tag: Issuer Public Key Remainder. Remaining digits of the Issuer Public Key Modulus. */
    ISSUER_PUBLIC_KEY_REMAINDER_0x92(0x92, "Issuer Public Key Remainder",
            ...
            new VariableDataLength(DataLength.DATA_LENGTH_VAR, DataLength.DATA_LENGTH_VAR), 0x70,
            new VariableByteLength(ByteLength.BYTE_LENGTH_VAR, ByteLength.BYTE_LENGTH_VAR)),
    /** EMV tag: Issuer Script Command. Contains a command for transmission to the ICC. */
    ...
    /** EMV tag: Issuer Script Identifier. Identification of the Issuer Script. */
    ...
    /** EMV tag: Issuer Script Template 1. Contains proprietary issuer data for transmission to the ICC before the second GENERATE AC command. */
    ...
    /** EMV tag: Issuer Script Template 2. Contains proprietary issuer data for transmission to the ICC after the second GENERATE AC command. */
    ...
    /** EMV tag: Last Online Application Transaction Counter (ATC) Register. ATC value of the last transaction that went online. */
    ...
    /** EMV tag: Log Entry. Provides the SFI of the Transaction Log file and its number of records. */
    ...
    /** EMV tag: Merchant Identifier. When concatenated with the Acquirer Identifier, uniquely identifies a given merchant. */
    ...
    /** EMV tag: Merchant Name and Location. Indicates the name and location of the merchant. */
    MERCHANT_NAME_AND_LOCATION_0x9F4E(0x9F4E, "Merchant Name and Location",
            ...
            DataLength.DATA_LENGTH_VAR), 0x00, new VariableByteLength(ByteLength.BYTE_LENGTH_VAR,
            ByteLength.BYTE_LENGTH_VAR)),
    /** EMV tag: Personal Identification Number (PIN) Try Counter. Number of PIN tries remaining. */
    ...
    READ_RECORD_RESPONSE_MESSAGE_TEMPLATE_0x70(
            ...
            TLVDataFormat.BINARY, new VariableDataLength(1, 252), 0x00, new VariableByteLength(1, 252)),
    /** EMV tag: Response Message Template Format 1. Contains the data objects (without tags and lengths) returned by the ICC in response to a command. */
    RESPONSE_MESSAGE_TEMPLATE_FORMAT_1_0x80(
            ...
            DataLength.DATA_LENGTH_VAR), 0x00, new VariableByteLength(ByteLength.BYTE_LENGTH_VAR,
            ByteLength.BYTE_LENGTH_VAR)),
    /** EMV tag: Response Message Template Format 2. Contains the data objects (with tags and lengths) returned by the ICC in response to a command. */
    RESPONSE_MESSAGE_TEMPLATE_FORMAT_2_0x77(
            ...
            DataLength.DATA_LENGTH_VAR), 0x00, new VariableByteLength(ByteLength.BYTE_LENGTH_VAR,
            ByteLength.BYTE_LENGTH_VAR)),
    /** EMV tag: Service Code. Service code as defined in ISO/IEC 7813 for track 1 and track 2. */
    ...
    /** EMV tag: Signed Dynamic Application Data. Digital signature on critical application parameters for DDA or CDA. */
    SIGNED_DYNAMIC_APPLICATION_DATA_0x9F4B(0x9F4B, "Signed Dynamic Application Data",
            ...
            ByteLength.BYTE_LENGTH_VAR)),
    /** EMV tag: Signed Static Application Data. Digital signature on critical application parameters for SDA. */
    ...
    /** EMV tag: Terminal Capabilities. Indicates the card data input, CVM, and security capabilities of the terminal. */
    ...
    /** EMV tag: Terminal Country Code. Indicates the country of the terminal, represented according to ISO 3166. */
    TERMINAL_COUNTRY_CODE_0x9F1A(0x9F1A, "Terminal Country Code",
            ...
            new FixedByteLength(2)),
    /** EMV tag: Terminal Floor Limit. Indicates the floor limit in the terminal in conjunction with the AID. */
    TERMINAL_FLOOR_LIMIT_0x9F1B(0x9F1B, "Terminal Floor Limit",
            ...
            DataSource.TERMINAL, TLVDataFormat.BINARY, new FixedDataLength(4), 0x00,
            new FixedByteLength(4)),
    /** EMV tag: Terminal Identification. Designates the unique location of a terminal at a merchant. */
    ...
    /** EMV tag: Terminal Risk Management Data. Application-specific value used by the card for risk management purposes. */
    ...
    /** EMV tag: Terminal Type. Indicates the environment of the terminal, its communications capability, and its operational control. */
    TERMINAL_TYPE_0x9F35(
            ...
            DataSource.TERMINAL, TLVDataFormat.PACKED_NUMERIC, new FixedDataLength(2), 0x00,
            new FixedByteLength(1)),
    /** EMV tag: Terminal Verification Results. Status of the different functions as seen from the terminal. */
    TERMINAL_VERIFICATION_RESULTS_0x95(0x95, "Terminal Verification Results",
            ...
            TLVDataFormat.BINARY, new FixedDataLength(5), 0x00, new FixedByteLength(5)),
    /** EMV tag: Track 1 Discretionary Data. Discretionary part of track 1 according to ISO/IEC 7813. */
    TRACK_1_DISCRETIONARY_DATA_0x9F1F(0x9F1F, "Track 1 Discretionary Data",
            ...
            DataLength.DATA_LENGTH_VAR), 0x70, new VariableByteLength(ByteLength.BYTE_LENGTH_VAR,
            ByteLength.BYTE_LENGTH_VAR)),
    /** EMV tag: Track 2 Discretionary Data. Discretionary part of track 2 according to ISO/IEC 7813. */
    ...
    /** EMV tag: Transaction Certificate (TC) Hash Value. Result of a hash function specified in Book 2, Annex B3.1. */
    ...
    /** EMV tag: Transaction Certificate Data Object List (TDOL). List of data objects (tag and length) to be used by the terminal in generating the TC Hash Value. */
    TRANSACTION_CERTIFICATE_DATA_OBJECT_LIST_0x97(
            ...
            DataSource.ICC, TLVDataFormat.BINARY, new VariableDataLength(1, 252), 0x70,
            new VariableByteLength(1, 252)),
    /** EMV tag: Transaction Currency Code. Indicates the currency code of the transaction according to ISO 4217. */
    ...
    /** EMV tag: Transaction Date. Local date that the transaction was authorised. */
    ...
    /** EMV tag: Transaction Personal Identification Number (PIN) Data. Data entered by the cardholder for the purpose of the PIN verification. */
    ...
    TRANSACTION_REFERENCE_CURRENCY_EXPONENT_0x9F3D(0x9F3D,
            ...
            new FixedByteLength(1)),
    /** EMV tag: Transaction Sequence Counter. Counter maintained by the terminal that is incremented by one for each transaction. */
    ...
    /** EMV tag: Transaction Status Information. Indicates the functions performed in a transaction. */
    ...
    /** EMV tag: Transaction Time. Local time that the transaction was authorised. */
    ...
    /** EMV tag: Unpredictable Number. Value to provide variability and uniqueness to the generation of a cryptogram. */
    ...
    /**
     * Returns {@code true} if the given tag code is not a known standard EMV tag.
     * @param code the tag code to test
    ...
    /**
     * Returns the {@link EMVStandardTagType} for the given numeric tag code.
     * @param code the numeric tag code
     * @return the matching enum constant
     * @throws UnknownTagNumberException if the code is not a known standard tag
     */
    ...
    /**
     * Returns the {@link EMVStandardTagType} for the given hexadecimal tag code string.
     * @param hexString the tag code as a hex string (e.g. {@code "9F26"})
     * @return the matching enum constant
     * @throws UnknownTagNumberException if the code is not a known standard tag
     */
    ...
    /**
     * Always returns {@code false} — standard tags are never proprietary.
     * @return false
     */
    ...
    /**
     * Returns {@code true} if this tag uses a proprietary data format.
    ...
    /**
     * Returns the template tag type for this tag, or {@code null} if there is no template.
    ...
    /** Lazily initialised map from tag number to enum constant. */
    ...
    public static class ProprietaryFixedDataLength extends DataLength {
         ...
         * @param length the fixed length value
         */
