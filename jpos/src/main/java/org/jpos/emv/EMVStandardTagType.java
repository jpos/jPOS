...
public enum EMVStandardTagType implements EMVTagType {
    ...
    ACCOUNT_TYPE_0x5F57(0x5F57, "Account Type",
            ...
            DataSource.TERMINAL, TLVDataFormat.COMPRESSED_NUMERIC, new FixedDataLength(2), 0x00,
    ...
    ACQUIRER_IDENTIFIER_0x9F01(0x9F01, "Acquirer Identifier",
            ...
            TLVDataFormat.COMPRESSED_NUMERIC, new VariableDataLength(6, 11), 0x00, new FixedByteLength(6)),
    ...
    AMOUNT_AUTHORISED_NUMERIC_0x9F02(0x9F02, "Amount, Authorised (Numeric)",
            "Authorised amount of the transaction (excluding adjustments)", DataSource.TERMINAL,
            TLVDataFormat.COMPRESSED_NUMERIC, new FixedDataLength(12), 0x00, new FixedByteLength(6)),
    ...
    AMOUNT_OTHER_NUMERIC_0x9F03(0x9F03, "Amount, Other (Numeric)",
            "Secondary amount associated with the transaction representing a cashback amount",
            DataSource.TERMINAL, TLVDataFormat.COMPRESSED_NUMERIC, new FixedDataLength(12), 0x00,
    ...
    APPLICATION_CURRENCY_CODE_0x9F42(0x9F42, "Application Currency Code",
            ...
            DataSource.ICC, TLVDataFormat.COMPRESSED_NUMERIC, new FixedDataLength(3), 0x70,
    ...
    APPLICATION_CURRENCY_EXPONENT_0x9F44(
            ...
            DataSource.ICC, TLVDataFormat.COMPRESSED_NUMERIC, new FixedDataLength(1), 0x70,
            new FixedByteLength(1)),
    ...
    APPLICATION_EFFECTIVE_DATE_0x5F25(0x5F25, "Application Effective Date",
            "Date from which the application may be used", DataSource.ICC, TLVDataFormat.DATE_YYMMDD,
            new FixedDataLength(6), 0x70, new FixedByteLength(3)),
    APPLICATION_EXPIRATION_DATE_0x5F24(0x5F24, "Application Expiration Date",
            "Date after which application expires", DataSource.ICC, TLVDataFormat.DATE_YYMMDD,
            new FixedDataLength(6), 0x70, new FixedByteLength(3)),
    ...
    APPLICATION_LABEL_0x50(0x50, "Application Label",
            ...
            TLVDataFormat.ALPHA_NUMERIC_SPACE, new VariableDataLength(1, 16), 0x61,
    ...
    APPLICATION_PREFERRED_NAME_0x9F12(0x9F12, "Application Preferred Name",
            ...
            TLVDataFormat.ALPHA_NUMERIC_SPECIAL, new VariableDataLength(1, 16), 0x61,
            new VariableByteLength(1, 16)),
    APPLICATION_PRIMARY_ACCOUNT_NUMBER_0x5A(0x5A, "Application Primary Account Number (PAN)",
            "Valid cardholder account number", DataSource.ICC, TLVDataFormat.CARD_NUMBER,
    ...
    APPLICATION_PRIMARY_ACCOUNT_NUMBER_SEQUENCE_NUMBER_0x5F34(0x5F34,
            ...
            TLVDataFormat.COMPRESSED_NUMERIC, new FixedDataLength(2), 0x70, new FixedByteLength(1)),
    ...
    APPLICATION_REFERENCE_CURRENCY_EXPONENT_0x9F43(
            ...
            TLVDataFormat.COMPRESSED_NUMERIC, new FixedDataLength(1), 0x70, new VariableByteLength(1, 4)),
    ...
    AUTHORISATION_RESPONSE_CODE_0x8A(0x8A, "Authorisation Response Code",
            ...
            TLVDataFormat.ALPHA_NUMERIC, new FixedDataLength(2), 0x00, new FixedByteLength(2)),
    ...
    CARDHOLDER_NAME_0x5F20(0x5F20, "Cardholder Name",
            ...
            TLVDataFormat.ALPHA_NUMERIC_SPECIAL, new VariableDataLength(2, 26), 0x70,
    ...
    CARDHOLDER_NAME_EXTENDED_0x9F0B(
            ...
            "Indicates the whole cardholder name when greater than 26 characters using the same coding convention as "
                    + "in ISO 7813", DataSource.ICC, TLVDataFormat.ALPHA_NUMERIC_SPECIAL,
    ...
    INTERFACE_DEVICE_IFD_SERIAL_NUMBER_0x9F1E(0x9F1E, "Interface Device (IFD) Serial Number",
            ...
            DataSource.TERMINAL, TLVDataFormat.ALPHA_NUMERIC, new FixedDataLength(8), 0x00,
    ...
    ISSUER_CODE_TABLE_INDEX_0x9F11(
            ...
            DataSource.ICC, TLVDataFormat.COMPRESSED_NUMERIC, new FixedDataLength(2), 0xA5,
            new FixedByteLength(1)),
    ISSUER_COUNTRY_CODE_0x5F28(0x5F28, "Issuer Country Code",
            ...
            TLVDataFormat.COMPRESSED_NUMERIC, new FixedDataLength(3), 0x70, new FixedByteLength(2)),
    ISSUER_COUNTRY_CODE_ALPHA_2_0x5F55(
            ...
            DataSource.ICC, TLVDataFormat.ALPHA, new FixedDataLength(2), 0xBF0C, new FixedByteLength(2)),
    ISSUER_COUNTRY_CODE_ALPHA_3_0x5F56(
            ...
            DataSource.ICC, TLVDataFormat.ALPHA, new FixedDataLength(3), 0xBF0C, new FixedByteLength(3)),
    ISSUER_IDENTIFICATION_NUMBER_0x42(
            ...
            TLVDataFormat.COMPRESSED_NUMERIC, new FixedDataLength(6), 0xBF0C, new FixedByteLength(3)),
    ...
    ISSUER_URL_0x5F50(0x5F50, "Issuer URL",
            ...
            DataSource.ICC, TLVDataFormat.ALPHA_NUMERIC_SPECIAL, new VariableDataLength(
    ...
    LANGUAGE_PREFERENCE_0x5F2D(0x5F2D, "Language Preference",
            "1-4 languages stored in order of preference, each represented by 2 alphabetical characters "
                    + "according to ISO 639", DataSource.ICC, TLVDataFormat.ALPHA_NUMERIC,
    ...
    MERCHANT_CATEGORY_CODE_0x9F15(
            ...
            TLVDataFormat.COMPRESSED_NUMERIC, new FixedDataLength(4), 0x00, new FixedByteLength(2)),
    MERCHANT_IDENTIFIER_0x9F16(0x9F16, "Merchant Identifier",
            ...
            DataSource.TERMINAL, TLVDataFormat.ALPHA_NUMERIC_SPECIAL, new FixedDataLength(15), 0x00,
    ...
    MERCHANT_NAME_AND_LOCATION_0x9F4E(0x9F4E, "Merchant Name and Location",
            ...
            TLVDataFormat.ALPHA_NUMERIC_SPECIAL, new VariableDataLength(DataLength.DATA_LENGTH_VAR,
            DataLength.DATA_LENGTH_VAR), 0x00, new VariableByteLength(ByteLength.BYTE_LENGTH_VAR,
            ByteLength.BYTE_LENGTH_VAR)),
    ...
    POINT_OF_SERVICE_POS_ENTRY_MODE_0x9F39(0x9F39, "Point-of-Service (POS) Entry Mode",
            "Indicates the method by which the PAN was entered, according to the first two digits of the ISO "
                    + "8583:1987 POS Entry Mode", DataSource.TERMINAL, TLVDataFormat.COMPRESSED_NUMERIC,
    ...
    TERMINAL_COUNTRY_CODE_0x9F1A(0x9F1A, "Terminal Country Code",
            ...
            DataSource.TERMINAL, TLVDataFormat.COMPRESSED_NUMERIC, new FixedDataLength(3), 0x00,
            new FixedByteLength(2)),
    ...
    TERMINAL_IDENTIFICATION_0x9F1C(0x9F1C, "Terminal Identification",
            ...
            TLVDataFormat.ALPHA_NUMERIC, new FixedDataLength(8), 0x00, new FixedByteLength(8)),
    ...
    TRACK_2_DISCRETIONARY_DATA_0x9F20(0x9F20, "Track 2 Discretionary Data",
            ...
            TLVDataFormat.CARD_NUMBER, new VariableDataLength(DataLength.DATA_LENGTH_VAR,
            DataLength.DATA_LENGTH_VAR), 0x70, new VariableByteLength(ByteLength.BYTE_LENGTH_VAR,
            ByteLength.BYTE_LENGTH_VAR)),
    ...
    TRANSACTION_CURRENCY_EXPONENT_0x5F36(0x5F36, "Transaction Currency Exponent",
            ...
            TLVDataFormat.COMPRESSED_NUMERIC, new FixedDataLength(1), 0x00, new FixedByteLength(1)),
    TRANSACTION_DATE_0x9A(0x9A, "Transaction Date",
            "Local date that the transaction was authorised", DataSource.TERMINAL, TLVDataFormat.DATE_YYMMDD,
    ...
    TRANSACTION_REFERENCE_CURRENCY_CODE_0x9F3C(0x9F3C, "Transaction Reference Currency Code",
            ...
            TLVDataFormat.COMPRESSED_NUMERIC, new FixedDataLength(3), 0x00, new FixedByteLength(2)),
    TRANSACTION_REFERENCE_CURRENCY_EXPONENT_0x9F3D(0x9F3D,
            ...
            DataSource.TERMINAL, TLVDataFormat.COMPRESSED_NUMERIC, new FixedDataLength(1), 0x00,
            new FixedByteLength(1)),
    TRANSACTION_SEQUENCE_COUNTER_0x9F41(0x9F41, "Transaction Sequence Counter",
            ...
            DataSource.TERMINAL, TLVDataFormat.COMPRESSED_NUMERIC, new VariableDataLength(4, 8), 0x00,
    ...
    TRANSACTION_TIME_0x9F21(0x9F21, "Transaction Time",
            "Local time that the transaction was authorised", DataSource.TERMINAL, TLVDataFormat.TIME_HHMMSS,
            new FixedDataLength(6), 0x00, new FixedByteLength(3)),
    TRANSACTION_TYPE_0x9C(
            ...
            TLVDataFormat.COMPRESSED_NUMERIC, new FixedDataLength(2), 0x00, new FixedByteLength(1)),
