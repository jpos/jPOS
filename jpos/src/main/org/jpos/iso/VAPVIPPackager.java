...
public class VAPVIPPackager extends ISOBasePackager {
    ...
    protected ISOFieldPackager fld[] = {
            ...
            new IF_ECHAR    ( 12, "RETRIEVAL REFERENCE NUMBER"),
            new IF_ECHAR    (  6, "AUTHORIZATION IDENTIFICATION RESPONSE"),
            new IF_ECHAR    (  2, "RESPONSE CODE"),
            new IF_ECHAR    (  3, "SERVICE RESTRICTION CODE"),
            ...
            new IF_ECHAR    (  1, "FILE UPDATE CODE"),
            new IF_ECHAR    (  2, "FILE SECURITY CODE"),
            new IF_ECHAR    (  5, "RESPONSE INDICATOR"),
            new IF_ECHAR    (  7, "SERVICE INDICATOR"),
            new IF_ECHAR    ( 42, "REPLACEMENT AMOUNTS"),
