...
public class VAPSMSPackager extends ISOBasePackager {
	...
	protected ISOFieldPackager fld[] = {
			...
			new IFB_LLCHAR	( 99, "ADITIONAL DATA - PRIVATE"),
			...
			new IFB_LLCHAR	(120, "ADDITIONAL AMOUNTS"),
			new IFB_LLBINARY(255, "RESERVED ISO"),
			new IFB_LLCHAR  (255, "RESERVED ISO"),
			new IFB_LLCHAR	(255, "RESERVED NATIONAL"),
			new IFB_LLCHAR	(255, "RESERVED NATIONAL"),
			new IFB_LLCHAR	( 14, "NATIONAL POS GEOGRAPHIC DATA"),
			new IFB_LLBINARY(  6, "RESERVED PRIVATE"),
			new IFB_LLHNUM 	( 36, "RESERVED PRIVATE", pad),
			new IFB_LLBINARY( 59, "PAYMENT SERVICE FIELDS"),
			new IFB_LLBINARY(255, "SMS PRIVATE-USE FIELDS"),
			...
			new IFB_LLCHAR	( 99, "RESERVED NATIONAL USE"),
			new IFB_LLCHAR	( 99, "RESERVED NATIONAL USE"),
			new IFB_LLBINARY( 99, "INTRA-COUNTRY DATA"),
			new IFB_LLCHAR	( 99, "RESERVED NATIONAL USE"),
