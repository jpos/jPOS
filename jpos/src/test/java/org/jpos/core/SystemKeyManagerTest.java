...
public class SystemKeyManagerTest {
    ...
    public void testGetDefaultKeyReturnsKey() {
        ...
        manager.generateDefaultKey();
        SecretKey key = manager.getDefaultKey();
        assertNotNull(key, "getDefaultKey() should return a key after generating");
    ...
    public void testGetKeyReturnsKey() {
        ...
        manager.generateKey(DEFAULT);
        SecretKey key = manager.getKey(DEFAULT);
        assertNotNull(key, "getKey() should return a key after generating");
    }
    ...
    public void testGetKeyBase64ReturnsValidBase64() {
        ...
        manager.generateKey(DEFAULT);
        String base64Key = manager.getKeyBase64(DEFAULT);
        assertNotNull(base64Key, "getKeyBase64() should return a string after generating");
        assertFalse(base64Key.isEmpty(), "Base64 string should not be empty");
    ...
    public void testEnvironmentVariableIsSet() {
        ...
        String keyBase64 = manager.getKeyBase64(DEFAULT);
