 ...
 */
public class IFE_LLLNUMTest {
    @Test
    public void testPackAnEmptyArray() throws Exception
    {
        ISOField field = new ISOField(9, "");
        IFE_LLLNUM packager = new IFE_LLLNUM(9, "testing packing an empty Array");
        TestUtils.assertEquals(new byte[] {(byte)0xF0,(byte)0xF0,(byte)0xF0},
                packager.pack(field));
    }
    ...
    public void testPackANonEmptyArray() throws Exception
    {
        ...
        IFE_LLLNUM packager = new IFE_LLLNUM(9, "testing packing a non empty Array");
        TestUtils.assertEquals(new byte[] {(byte) 0xF0,(byte) 0xF0,(byte) 0xF2, (byte) 0xF1, (byte) 0xF2},
                packager.pack(field));
    }
    ...
    public void testPackAFullArray() throws Exception
    {
        ...
        IFE_LLLNUM packager = new IFE_LLLNUM(9, "testing packing a full Array");
        TestUtils.assertEquals(new byte[] {
                        (byte) 0xF0,(byte) 0xF0,(byte) 0xF9,
    ...
    {
        byte[] raw = new byte[] {(byte) 0xF0, (byte) 0xF0, (byte) 0xF0};
        IFE_LLLNUM packager = new IFE_LLLNUM(9, "testing unpacking an empty Array");
        ISOField field = new ISOField(9);
    ...
    {
        byte[] raw = new byte[] {(byte) 0xF0, (byte) 0xF0, (byte) 0xF2, (byte) 0xF1, (byte) 0xF2};
        IFE_LLLNUM packager = new IFE_LLLNUM(9, "testing unpacking a non empty Array");
        ISOField field = new ISOField(9);
        packager.unpack(field, raw, 0);
    ...
    public void testUnpackAMaxLengthArray() throws Exception
    {
        byte[] raw = new byte[] {
                ...
                (byte) 0xF4, (byte) 0xF5, (byte) 0xF6,
                (byte) 0xF7, (byte) 0xF8, (byte) 0xF9};
        IFE_LLLNUM packager = new IFE_LLLNUM(9, "testing unpacking a max length Array");
        ISOField field = new ISOField(9);
        packager.unpack(field, raw, 0);
    ...
    {
        IFE_LLLNUM packager = new IFE_LLLNUM(9, "testing packing and unpacking cycle");
    ...
    {
        byte[] raw = new byte[] {0x30, 0x31, (byte) 0xF0, (byte) 0xF0, (byte) 0xF2, (byte) 0xF1, (byte) 0xF1};
        IFE_LLLNUM packager = new IFE_LLLNUM(9, "testing unpacking a non empty Array with an offset");
        ISOField field = new ISOField(9);
